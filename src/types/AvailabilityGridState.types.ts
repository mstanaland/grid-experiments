import { DateValue, type CalendarDate } from "@internationalized/date";
...
export interface AvailabilityGridState {
  ...
  selectDate(date: CalendarDate, siteId: string): void;
  ...
  isSelected(date: CalendarDate, siteId: string): boolean;
  ...
  getAvailability(date: CalendarDate, siteId: string): string;
}
